...
public class EnderecoController {
	...
	public ResponseEntity<Endereco> getEnderecoById(@PathVariable("id_endereco") long id_endereco) {
		return new ResponseEntity<Endereco>(service.getEnderecoById(id_endereco), HttpStatus.OK);
	}
