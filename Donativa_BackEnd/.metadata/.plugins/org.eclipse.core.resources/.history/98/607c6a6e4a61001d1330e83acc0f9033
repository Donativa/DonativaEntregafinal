...
public class UsuarioController {
	...
	public ResponseEntity<Usuarios> getUsuariosById(@PathVariable("id_usuario") long id_usuario) {
		return new ResponseEntity<Usuarios>(service.getUsuariosById(id_usuario), HttpStatus.OK);
	}
